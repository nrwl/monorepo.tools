      ...
      <div className="mt-24 lg:mt-36 relative max-w-lg mx-auto lg:max-w-7xl">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-3 text-xl text-gray-700 dark:text-gray-300 sm:mt-4">
            ...
            the way you think about code. Creating new projects, sharing code,
            refactoring are much easier and faster: no API is ever hard to
            change. Developers can work in a more agile fashion.
          </p>
        </div>
      </div>
    </article>
