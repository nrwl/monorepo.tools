        ...
        <header className="relative px-4 py-24 sm:px-6 md:grid md:min-h-screen md:place-items-center lg:px-8">
          <div className="mx-auto max-w-max">
            <div data-test-id="website-name" className="w-full">
              <span className="text-5xl font-extrabold tracking-tighter text-gray-900 sm:text-8xl dark:text-white">
                monorepo
              </span>
          ...
          <a
            ...
            aria-hidden="true"
            className="absolute bottom-2 left-1/2 -ml-4 hidden lg:block"
          >
            <svg
